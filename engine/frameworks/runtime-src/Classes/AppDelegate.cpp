...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("goldfish");
#else
        glview = cocos2d::GLViewImpl::createWithRect("goldfish", Rect(0,0,960,640));
#endif
    ...
    sc->addRegisterCallback(register_nativeDevice);
    sc->addRegisterCallback(register_facebook);
    sc->addRegisterCallback(register_firebaseMessaging);
    sc->addRegisterCallback(register_analytics);
