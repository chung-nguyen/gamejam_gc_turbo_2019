...
var AsyncLock = function(options) {
    ...
    this.options = AsyncLock.defaultOptions;
...
AsyncLock.elapsed = function() {
    return new Date() - this.start;
};

AsyncLock.leave = function() {
    if (this.lock) {
...
AsyncLock.prototype.createToken = function(callback) {
    return {
        id: AsyncLock.tokenId++,
        isCanceled: false,
        callback: callback,
        elapsed: AsyncLock.elapsed,
        start: new Date(),
        lock: this,
        leave: AsyncLock.leave
    };
};
...
AsyncLock.prototype.enter = function(callback, timeout) {
    ...
    if (this.ownerTokenId !== null) {
        ...
        var i,
            reducedTokens = this.reduceQueue(this.queue, this.options);
